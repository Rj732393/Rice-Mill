<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copy of PurchaseUnloading.aspx.cs" Inherits="PurchaseUnloading" %>
...
<body>
  ...
  <div id='center' class="main center" style="font-size:12px !important;">
   ...
   <div class="row">
      ...
      <tr><td align="left"><div><label for="moisture" style="display:table-cell">Moisture (In %, <=17): </label>
      <span style="display:table-cell">
