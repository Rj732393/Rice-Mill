<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaddyStock.aspx.cs" Inherits="PaddyStock" %>
  ...
  <div class="row">
      ...
      <div class="col-75">
        ...
        <asp:Panel ID="Panel1" runat="server">
         <div class="row">
      <div class="col-25">
        <label for="rweight">Paddy Weight (In KG)</label>
      </div>
      <div class="col-75">
        <input id="pweight" name="pweight" required runat="server" style="text-align:right"/>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      <div class="col-25">
        <label for="ramount">Paddy Amount (In Rs.)</label>
      </div>
      <div class="col-75">
        <input id="pamount" name="pamount" readonly runat="server" style="text-align:right"/>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
