...
public partial class SO : System.Web.UI.Page
{
    ...
    public void dataDisplay()
    {
        ...
        q = "select * from [prabha].[Sale_Sauda_Master] where ID=@ID";
        dac = new DataAccessLayer();
        dtMain = dac.GetDataTable(q, param);
        ...
        else
        {
            ...
            string InvNo = GenInvoiceNo(dtMain.Rows[0]["No"].ToString(), dtMain.Rows[0]["DataDate"].ToString());
            ...
            {
                htmlTable.Append("<td colspan='2' align='left'>Sauda No.: <b>" + InvNo + "</b></br>Manual Sauda No.: <b>" + dtMain.Rows[0]["MNo"].ToString() + "</b></td></tr>");
            }
            ...
            param = new List<SqlParameter>();
            param.Add(new SqlParameter("@ID", Request.QueryString["ID"].ToString()));
            q = "select * from [prabha].[Sale_Sauda_Item_Info] where MasterID=@ID";
            dac = new DataAccessLayer();
